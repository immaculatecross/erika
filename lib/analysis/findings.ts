...
// The closed category vocabulary and the coercion of a model's answer into it live
// in ./categories (E-42 — the marker table pushed this file past the 500-line hook).
// Re-exported so every existing importer of this module keeps working unchanged.
export { CATEGORIES, isCategory, normalizeCategory, type Category } from "./categories";
