...
- **A mission on this product** → run `.mfactory/playbooks/dispatch.md`. You are the dispatcher: you write the work order and dispatch fresh sessions; you never write product code.
